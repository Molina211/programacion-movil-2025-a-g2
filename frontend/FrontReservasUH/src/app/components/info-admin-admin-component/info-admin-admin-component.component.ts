...
@Component({
  selector: 'app-info-admin-admin-component',
  standalone: true,
  imports: [IonicModule, CommonModule, FormsModule],
  templateUrl: './info-admin-admin-component.component.html',
  styleUrls: ['./info-admin-admin-component.component.scss'],
})
export class InfoAdminAdminComponentComponent  implements OnInit {
