...
@Component({
  ...
  templateUrl: './perfil-estudiante-component.component.html',
  styleUrls: ['./perfil-estudiante-component.component.scss'],
})
export class PerfilEstudianteComponentComponent  implements OnInit {
