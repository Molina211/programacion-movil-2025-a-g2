...
@Component({
  selector: 'app-registrar-admin-form',
  standalone: true,
  imports: [IonicModule, FormsModule, CommonModule],
  templateUrl: './registrar-admin-form.component.html',
  styleUrls: ['./registrar-admin-form.component.scss'],
})
export class RegistrarAdminFormComponent  implements OnInit {
