...
@Component({
  selector: 'app-registrar-empleado-form',
  standalone: true,
  imports: [IonicModule, FormsModule, CommonModule],
  templateUrl: './registrar-empleado-form.component.html',
  styleUrls: ['./registrar-empleado-form.component.scss'],
})
export class RegistrarEmpleadoFormComponent  implements OnInit {
